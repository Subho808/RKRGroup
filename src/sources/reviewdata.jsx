import {  MdOutlinePeople, MdOutlineCardTravel } from "react-icons/md";
...
import { GiGasPump, GiFactory, GiElectric } from "react-icons/gi";
import { FaRecycle, FaWarehouse, FaProjectDiagram } from "react-icons/fa";
...
export const FutureBusinessData = [
  {
    icon: <GiGasPump />,
    title: "Biogas Production",
    desc: [
      "Anaerobic digestion systems for organic waste conversion.",
      "Biogas purification and upgrading to biomethane.",
      "Industrial and agricultural biogas plant development."
    ]
  },
  {
    icon: <FaRecycle />,
    ...
    desc: [
      ...
      "Municipal and industrial waste-to-energy projects.",
      "Sustainable fertilizer production from digestate."
    ]
  },
  {
    icon: <FaWarehouse />,
    title: "Biogas Storage & Distribution",
    desc: [
      "Compressed biogas (CBG) and liquefied biogas (LBG) supply.",
      "Biogas-to-grid injection solutions.",
      "Biogas-powered electricity generation."
    ]
  },
  {
    icon: <FaProjectDiagram />,
    title: "Consulting & Project Development",
    desc: [
      "Feasibility studies and environmental impact assessments.",
      "Turnkey biogas plant design and implementation.",
      "Government and private sector advisory on biogas policies."
    ]
  }
];
